"""
Django settings for hfgkjhafgjdak_3 project.
...
ROOT_URLCONF = 'hfgkjhafgjdak_3.urls'
...
WSGI_APPLICATION = 'hfgkjhafgjdak_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hfgkjhafgjdak_3 API",
    "DESCRIPTION": "API documentation for hfgkjhafgjdak_3 App",
    "VERSION": "v1",
}
